...
<title>Editor</title>
<script type="text/javascript" src="<?php echo $house_config['house'];?>editor/common.js"></script>
<script type="text/javascript" src="<?php echo $house_config['house'];?>editor/home.js"></script>
<script language="javascript" src="<?php echo $house_config['house'];?>editor/editor_base.js"></script>
<style type="text/css">
