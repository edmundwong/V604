...
require DISCUZ_ROOT.'./source/plugin/sale/include/function.class.php';if( !cloudaddons_getmd5("sale.plugin") ) {/* cpmsg(lang('admincp_msg','cloudaddons_genuine_message'),'','error',array('addonid' => "sale.plugin"));*/}

$style ='default';
include template("sale:admin/admin_help");
?>