...
(function(){
    ...
    function changeselected(o){
        if ( o.getAttribute( "selected" ) ) {
            ...
            o.style.cssText = "filter:alpha(Opaarea=100);-moz-opaarea:1;opaarea: 1;border: 2px solid #fff";
        } else {
            o.setAttribute( "selected", "true" );
            o.style.cssText = "filter:alpha(Opaarea=50);-moz-opaarea:0.5;opaarea: 0.5;border:2px solid blue;";
        }
    }
