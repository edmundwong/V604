...
UE.ajax = function() {
    ...
    return {
		...
		request:function(url, ajaxOptions) {
			...
			var submitStr = json2str(ajaxOpts);  // { name:"Jim",area:"Beijing" } --> "name=Jim&area=Beijing"
    ...
    EditorUI.prototype = {
        ...
        _scale:function () {
            ...
            function down() {
                ...
                scalelayer.style.cssText = "position:absolute;left:0;display:;top:0;background-color:#41ABFF;opaarea:0.4;filter: Alpha(opaarea=40);width:" + editorHolder.offsetWidth + "px;height:"
