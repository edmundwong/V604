...
(function () {
	...
	URL= SITEURL + "source/plugin/gongqiu/ueditor/";
    ...
    window.UEDITOR_CONFIG = {
       ...
       //,maxImageSideLength:1200                    //上传图片最大允许的边长，超过会自动等比缩放,不缩放就设置一个比较大的值，更多设置在image.html中
        ...
        ,toolbars:[["fontfamily","fontsize","forecolor","backcolor","bold","underline","strikethrough","italic","justifyleft","justifycenter","justifyright","justifyjustify","indent","superscript","subscript","spechars","customstyle","insertimage","music","insertvideo","wordimage","map","gmap","link","unlink","removeformat","formatmatch","undo","redo","blockquote","pasteplain","fullscreen"]]
