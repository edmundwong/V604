...
if(empty($_GET['charset']) || !in_array(strtolower(addslashes($_GET['charset'])), array('gbk', 'big5', 'utf-8'))) {
	$_GET['charset'] = '';
}
$get_charset = CHARSET;
...
<title>Editor</title>
<script type="text/javascript" src="<?php echo $info_config['info'];?>editor/common.js"></script>
<script type="text/javascript" src="<?php echo $info_config['info'];?>editor/home.js"></script>
<script language="javascript" src="<?php echo $info_config['info'];?>editor/editor_base.js"></script>
...
<SCRIPT LANGUAGE="JavaScript">
	...
	if(document.all){
		document.write('<table width="100%" height="369" border="0" cellspacing="0" cellpadding="0" id="divEditor"><tr><td style="padding-left:4px;background-color:#fff"><IFRAME class="HtmlEditor" ID="HtmlEditor" name="HtmlEditor" style="height:100%;width:100%" frameBorder="0" marginHeight=0 marginWidth=0 src="home.php?mod=editor&op=blank&charset=<?php echo $get_charset;?>" onload="blank_load();"></IFRAME></td></tr></table>');
	}else{
		document.write('<table width="100%" height="369" border="0" cellspacing="0" cellpadding="0" id="divEditor"><tr><td style="padding-left:4px;background-color:#fff"><IFRAME class="HtmlEditor" ID="HtmlEditor" name="HtmlEditor" style="height:100%;width:100%;" frameBorder="0" marginHeight=0 marginWidth=0 src="home.php?mod=editor&op=blank&charset=<?php echo $get_charset;?>" onload="blank_load();"></IFRAME></td></tr></table>');
	}
</SCRIPT>
