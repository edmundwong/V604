<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('header');?><?php include template('common/header'); ?><style id="diy_style" type="text/css"></style>
...
<script src="<?php echo $_G['style']['v604t_common'];?>js/respond.js" type="text/javascript"></script>
