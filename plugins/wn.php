...
<body class="PopupBody PopupTabArea" onLoad="initial()">
<SCRIPT language=JavaScript>
<!--
...
<tr>
	<td align="center" class="PopupTitleBorder BackColor" style="text-align: left; padding: 15px">
  ...
  <TR>
    <TD vAlign=top align=middle><BR><FONT style="FONT-SIZE: 12px" >本机时间:</FONT><BR><FONT id=Clock face=Arial color=#000080 size=4 
      align="center"></FONT>
      <P><!--时区 *表示自动调整为日光节约时间--><FONT style="FONT-SIZE: 12px" size=2><SELECT 
      style="FONT-SIZE: 12px" onchange=changeTZ() name=TZ> <OPTION 
      ...
      id=CITY 
      style="FONT-SIZE: 12px; WIDTH: 150px; COLOR: blue; FONT-FAMILY: '新细明体'"></FONT></P>
      </TD>
    <TD align=middle>
      ...
      <TABLE border=0>
        ...
        <TR>
          <TD bgColor=#000080 colSpan=7><FONT style="FONT-SIZE: 12px" 
            color=#ffffff size=2>公历<SELECT style="FONT-SIZE: 12px" 
            onchange=changeCld() name=SY> 
              <SCRIPT language=JavaScript><!--
            for(i=1900;i<2050;i++) document.write('<option>'+i)
            //--></SCRIPT>

            </SELECT>年<SELECT style="FONT-SIZE: 12px" onchange=changeCld() 
            name=SM> 
              <SCRIPT language=JavaScript><!--
        ...
        <SCRIPT language=JavaScript><!--
            ...
            for(i=0;i<6;i++) {
               ...
               for(j=0;j<7;j++) {
                  ...
                  document.write(' TITLE=""> </font><br><font id="LD' + gNum + '" size=2 style="font-size:12px"> </font></td>')
               }
               document.write('</tr>')
            }
            //--></SCRIPT>
    ...
    <TD vAlign=top align=middle width=40><BR><BR><BR><BR><BUTTON 
      style="FONT-SIZE: 12px" onClick="pushBtm('YU')">年↑</BUTTON><BR><BUTTON 
      style="FONT-SIZE: 12px" onClick="pushBtm('YD')">年↓</BUTTON> 
      <P><BUTTON style="FONT-SIZE: 12px" 
      onclick="pushBtm('MU')">月↑</BUTTON><BR><BUTTON style="FONT-SIZE: 12px" 
      onclick="pushBtm('MD')">月↓</BUTTON> 
      <P><BUTTON style="FONT-SIZE: 12px" onClick="pushBtm('')">今日</BUTTON> 
  </P></TD></TR></TABLE></FORM>
<HR  color=#cccccc noShade SIZE=1 style="margin: 10px 0">
阳历中 <FONT 
...
color=blue>蓝色</FONT> 则表示为公众节假日</CENTER>
